...
function createCheckbox(checkboxCount){
...
function createCustomCheckbox(checkboxCount){
...
function increaseAddedTask(height, heightChange, addedTask){
    addedTask.style = `height: ${height}px`;
    ELEMENT_HEIGHT.HIGH_FORM_HEIGHT += heightChange;
    UI_ElEMENTS.HIGH_FORM.style = `height: ${ELEMENT_HEIGHT.HIGH_FORM_HEIGHT}px`;
    ELEMENT_HEIGHT.LOW_BUTTON_ADD += heightChange;
    UI_ElEMENTS.ADD_LOW_BUTTON.style = `top: ${ELEMENT_HEIGHT.LOW_BUTTON_ADD}px`;
}

function decreaseField(heightChange){
    ELEMENT_HEIGHT.HIGH_FORM_HEIGHT -= heightChange;
    UI_ElEMENTS.HIGH_FORM.style = `height: ${ELEMENT_HEIGHT.HIGH_FORM_HEIGHT}px`;
    ELEMENT_HEIGHT.LOW_BUTTON_ADD -= heightChange;
    UI_ElEMENTS.ADD_LOW_BUTTON.style = `top: ${ELEMENT_HEIGHT.LOW_BUTTON_ADD}px`;
...
function increaseHeightNewTask(src, addedTask){
    if (src.length > LENGTH_OF_INPUT_FIELD.X_LARGE){
        increaseAddedTask(CHANGE_HEIGHT_NUMBERS.X_LARGE, CHANGE_HEIGHT_NUMBERS.X_LARGE_CHANGE, addedTask)
    }
...
function decreaseHeightField(src){
    if (src.length > LENGTH_OF_INPUT_FIELD.X_LARGE){
        decreaseField(CHANGE_HEIGHT_NUMBERS.X_LARGE_DECREASE)
    }
    else if (src.length > LENGTH_OF_INPUT_FIELD.LARGE){
...
function createTask(){
    ...
    addedTask.style = `height: ${ELEMENT_HEIGHT.HIGH_FORM_HEIGHT}px`;
    return addedTask;
}

function changeFieldHeight(){
    ...
    UI_ElEMENTS.HIGH_FORM.style = `height: ${ELEMENT_HEIGHT.HIGH_FORM_HEIGHT}px`;
    UI_ElEMENTS.ADD_LOW_BUTTON.style = `height: ${ELEMENT_HEIGHT.LOW_BUTTON_ADD}px`;
}
